...
class Program
{
    ...
    private static void guardarrespuestasBD(aprendiz aprendiz)
    {
        Console.WriteLine("Felicitaciones sr(a) " + aprendiz.nombres + " " + aprendiz.apellidos + " " + "sus datos han sido guardados en la Base de Datos");
        Console.ReadLine();
    }
